              ...
              <Card className="md:col-span-2 border-none shadow-md">
                ...
                <CardContent className="space-y-6">
                  <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-8 text-center hover:bg-muted/30 transition-colors cursor-pointer group">
                    ...
                    <Button variant="outline" size="sm" className="gap-2 text-muted-foreground border-muted hover:border-primary/50 hover:text-primary hover:bg-primary/5 shadow-sm bg-card font-serif font-normal text-base transition-all hover:shadow-md hover:-translate-y-0.5">Select Files</Button>
                  </div>
