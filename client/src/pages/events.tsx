    ...
    <Layout>
      <div className="max-w-7xl mx-auto p-4 lg:p-8">
        <div className="flex flex-col md:flex-row justify-between items-end gap-4 mb-8">
          ...
          <Button className="bg-[#6600ff] hover:bg-[#5500dd] text-white shadow-lg rounded-2xl font-bold" data-testid="button-create-event">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="hidden lg:block sticky top-4">
            <Card className="border-none shadow-md bg-card">
              <CardContent className="p-4">
                ...
                <div className="mt-4 pt-4 border-t flex justify-end">
                  <Button size="sm" className="text-xs h-7 rounded-lg bg-[#6600ff] hover:bg-[#5500dd] text-white font-bold" data-testid="button-today">Today</Button>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="mt-6 p-4 bg-primary/5 rounded-xl border border-primary/10">
              ...
              <Button className="w-full rounded-2xl bg-[#6600ff] hover:bg-[#5500dd] text-white font-bold" data-testid="button-learn-more">Learn More</Button>
            </div>
          </div>
        </div>
      </div>
