                                      ...
                                      <div className="space-y-6">
                                        ...
                                        {/* Gratitude */}
                                         <div className="flex-1">
                                            <div className="text-[11px] font-bold text-muted-foreground uppercase mb-2">Morning Gratitude</div>
                                ...
                                <div className="flex flex-col space-y-6 bg-muted/5 p-5 rounded-2xl border border-border/20 h-full relative">
                                       ...
                                       <div className="flex flex-col h-full justify-between">
                                          <div className="space-y-6">
                                              ...
                                              {entry.focusArea && (
                                                <div className="bg-white/30 rounded-lg p-3 border border-border/20 space-y-2">
                                                  <div className="flex items-center justify-between mb-1 pt-1">
                                                    <div className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider font-serif">Big Dream: <span style={{ color: entry.focusArea.color }}>{entry.focusArea.name}</span></div>
                                              ...
                                              {/* Values */}
                                              <div>
                                                <div className="text-[11px] font-bold text-muted-foreground uppercase mb-2 flex justify-between">
                                          ...
                                          <div className="mt-6 pt-4 border-t border-border/10">
                                              <div className="text-[11px] font-bold text-red-900/60 uppercase mb-1">Villain (Obstacle)</div>
                                    ...
                                    <div className="flex-1">
                                            <div className="flex flex-col h-full space-y-6">
                                              ...
                                              <div className="bg-white/50 rounded-xl h-10 px-3 border border-border/40 flex justify-between items-center">
                                               ...
                                               {/* Victory */}
                                              <div>
                                                <div className="text-[11px] font-bold text-muted-foreground uppercase mb-1 flex items-center gap-1">
                                               ...
                                               <div className="pt-2 border-t border-border/20 flex-1">
                                                <div className="text-[11px] font-bold text-muted-foreground uppercase mb-1">Lessons & Blessings</div>
