                                    ...
                                    <div className="flex items-center gap-2 mb-4">
                                      ...
                                      <div className="space-y-6">
                                        ...
                                        <div className="bg-white/50 rounded-xl h-10 px-3 border border-border/40 flex justify-between items-center">
                                          <div className="text-[13px] font-bold text-muted-foreground uppercase tracking-wider">Morning Vibe</div>
                                        ...
                                        {/* Gratitude */}
                                         <div className="flex-1">
                                            <div className="text-[13px] font-bold text-muted-foreground uppercase tracking-wider mb-2">Morning Gratitude</div>
                                ...
                                <div className="flex flex-col space-y-6 bg-muted/5 p-5 rounded-2xl border border-border/20 h-full relative">
                                       ...
                                       <div className="flex flex-col h-full justify-between">
                                          <div className="space-y-6">
                                              ...
                                              {entry.focusArea && (
                                                <div className="bg-white/30 rounded-lg p-3 border border-border/20 space-y-2">
                                                  <div className="flex items-center justify-between mb-1 pt-1">
                                                    <div className="text-[13px] font-bold text-muted-foreground uppercase tracking-wider font-serif">Big Dream: <span style={{ color: entry.focusArea.color }}>{entry.focusArea.name}</span></div>
                                              ...
                                              {/* Values */}
                                              <div>
                                                <div className="text-[13px] font-bold text-muted-foreground uppercase tracking-wider mb-2 flex justify-between">
                                          ...
                                          <div className="mt-6 pt-4 border-t border-border/10">
                                              <div className="text-[13px] font-bold text-red-900/60 uppercase tracking-wider mb-1">Villain (Obstacle)</div>
                                ...
                                <div className="flex flex-col h-full bg-muted/5 p-5 rounded-2xl border border-border/20 shadow-sm">
                                    ...
                                    <div className="flex-1">
                                            <div className="flex flex-col h-full space-y-6">
                                               {/* Evening Vibe */}
                                              <div className="bg-white/50 rounded-xl h-10 px-3 border border-border/40 flex justify-between items-center">
                                                <div className="text-[13px] font-bold text-muted-foreground uppercase tracking-wider">Evening Vibe</div>
                                               ...
                                               {/* Victory */}
                                              <div>
                                                <div className="text-[13px] font-bold text-muted-foreground uppercase tracking-wider mb-1 flex items-center gap-1">
                                               ...
                                               <div className="pt-2 border-t border-border/20 flex-1">
                                                <div className="text-[13px] font-bold text-muted-foreground uppercase tracking-wider mb-1">Lessons & Blessings</div>
