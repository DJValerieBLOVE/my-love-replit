...
import { PenLine, Calendar, Search, Filter, Book } from "lucide-react";
    ...
    <Layout>
      <div className="max-w-5xl mx-auto p-4 lg:p-8 space-y-8">
        <div className="flex items-end justify-between">
          ...
          <Button className="bg-[#6600ff] hover:bg-[#5500dd] text-white font-bold gap-2 shadow-md shadow-primary/20">
