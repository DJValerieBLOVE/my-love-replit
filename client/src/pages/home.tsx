      ...
      <div className="max-w-5xl mx-auto p-4 lg:p-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-4">
          ...
          <div className="flex items-center gap-3">
            <Button variant="outline" className="gap-2 text-muted-foreground border-muted hover:border-primary/50 hover:text-primary shadow-sm bg-card font-serif font-normal text-base">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <CardContent className="p-8 relative z-10 flex flex-col justify-between h-full">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <Button variant="outline" className="bg-card hover:bg-primary/5 text-muted-foreground border-muted hover:border-primary/50 hover:text-primary font-normal shadow-sm font-serif text-base">
                      Capture Reflection
                    </Button>
                  </div>
                </div>
            ...
            <Card className="border-none shadow-md overflow-hidden group cursor-pointer hover:shadow-lg transition-all h-full flex flex-col">
              ...
              <CardContent className="p-4 flex flex-col justify-between flex-1">
                ...
                <Button className="w-full font-normal text-muted-foreground border-muted hover:border-primary/50 hover:text-primary shadow-sm bg-card font-serif text-base" variant="outline">Continue</Button>
              </CardContent>
            </Card>
          </div>
