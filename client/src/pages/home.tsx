      ...
      <div className="max-w-5xl mx-auto p-4 lg:p-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/journal">
              <Button className="px-6 gap-2 font-bold h-10 bg-love-body text-white border border-transparent hover:bg-[#F5F3FF] hover:text-love-body hover:border-love-body hover:shadow-md transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <CardContent className="p-8 relative z-10 flex flex-col justify-between h-full">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <Button variant="outline" className="h-10 px-6 hover:shadow-md transition-all hover:text-love-body hover:border-love-body">
                      Capture Reflection
                    </Button>
                  </div>
                </div>
            ...
            <Card className="border-none shadow-md overflow-hidden group cursor-pointer hover:shadow-lg transition-all h-full flex flex-col">
              ...
              <CardContent className="p-4 flex flex-col justify-between flex-1">
                ...
                <Button className="w-full h-10 hover:shadow-md transition-all hover:text-love-body hover:border-love-body" variant="outline">Continue</Button>
              </CardContent>
            </Card>
          </div>
