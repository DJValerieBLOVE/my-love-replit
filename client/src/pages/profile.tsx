        ...
        <div className="max-w-3xl mx-auto px-4 -mt-16 relative z-10">
          ...
          <div className="grid grid-cols-3 md:grid-cols-5 gap-4">
            {CURRENT_USER.badges.map((badge, i) => (
              <div key={i} className="aspect-square rounded-xl bg-muted/50 flex flex-col items-center justify-center p-2 text-center gap-2 hover:bg-muted transition-colors cursor-pointer group">
            ...
            <div className="aspect-square rounded-xl border-2 border-dashed border-muted flex flex-col items-center justify-center p-2 text-center gap-2 opacity-50">
