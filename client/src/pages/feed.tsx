...
function LinkPreviewCard({ url }: { url: string }) {
  ...
  return (
    <a
      ...
      className="mt-2 block rounded-xs border border-border overflow-hidden hover:border-foreground/20 transition-colors group bg-muted"
...
function EmbeddedNoteCard({ eventId, bech32 }: { eventId: string; bech32: string }) {
  ...
  if (loading) {
    return (
      <div className="my-2 rounded-xs border border-gray-200 p-3 animate-pulse" data-testid="nostr-event-link">
  ...
  if (!note) {
    return (
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="my-2 block rounded-xs border border-gray-200 p-3 text-xs text-muted-foreground hover:border-[#6600ff] transition-colors"
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="my-2 block rounded-xs border border-gray-200 p-3 hover:border-[#6600ff] transition-colors group"
      data-testid="nostr-event-link"
    >
