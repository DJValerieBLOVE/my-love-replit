...
export function EveningModal({ morningData, isOpen, onOpenChange, onComplete }: EveningModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl p-0 gap-0 overflow-hidden bg-[#F5F3FF] dark:bg-[#1A052E] border-none shadow-2xl">
        ...
        <div className="p-8 space-y-8 relative z-10 max-h-[90vh] overflow-y-auto">
