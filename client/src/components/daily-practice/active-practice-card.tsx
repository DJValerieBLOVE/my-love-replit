          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
            ...
            <div className="flex flex-col space-y-5 bg-muted/5 p-5 rounded-2xl border border-border/20 h-full">
                ...
                <div className="space-y-2 flex-1 flex flex-col">
                    <label className="text-[15px] font-bold text-muted-foreground block">Morning Gratitude</label>
            ...
            <div className="flex flex-col space-y-6 bg-muted/5 p-5 rounded-2xl border border-border/20 h-full">
                ...
                <div className="space-y-2">
                    <label className="text-[15px] font-bold text-muted-foreground block mt-2.5 ml-1">Big Dream</label>
                ...
                <div className="space-y-3 flex-1 pt-2">
                     <div className="text-[15px] font-bold text-muted-foreground flex justify-between">
                ...
                <div className="space-y-2 pt-4 border-t border-border/10 mt-auto">
                    <label className="text-[15px] font-bold text-red-900/60">Villain (Obstacle)</label>
                    <Input 
            ...
            <div className="flex flex-col space-y-5 bg-muted/5 p-5 rounded-2xl border border-border/20 h-full">
                ...
                <div className="bg-white/50 rounded-xl px-3 h-10 border border-border/40 flex justify-between items-center transition-all hover:shadow-sm">
                 ...
                 {/* Victory Input */}
                <div className="space-y-2">
                    <label className="text-[15px] font-bold text-muted-foreground flex items-center gap-1">
                ...
                <div className="flex-1 flex flex-col space-y-2 pt-2 border-t border-border/20">
                    <label className="text-[15px] font-bold text-muted-foreground block">Lessons & Blessings</label>
                     <Textarea 
