...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-foreground text-background font-normal font-serif border border-foreground shadow-sm hover:bg-white hover:text-foreground hover:border-[#E5E5E5] hover:shadow-md hover:-translate-y-0.5 disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-[#A1A1AA] disabled:text-white disabled:border-[#A1A1AA]",
        destructive:
        ...
        outline:
          "bg-white text-muted-foreground border border-[#E5E5E5] font-serif font-normal text-sm shadow-sm hover:bg-white hover:text-foreground hover:border-gray-400 hover:shadow-md hover:-translate-y-0.5 disabled:bg-white disabled:text-[#A1A1AA] disabled:border-[#E5E5E5] disabled:pointer-events-none",
        secondary:
