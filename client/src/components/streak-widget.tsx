      ...
      <CardContent className="p-4">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-normal text-muted-foreground leading-none">Daily Streak</h3>
              <p className="text-xs text-muted-foreground mt-1">Zap in every day!</p>
            </div>
          </div>
          <div className="text-2xl font-normal text-orange-500 font-serif">{streak}</div>
        </div>
        ...
        <div className="flex justify-between items-center">
          {data.map((day, i) => (
            <div key={i} className="flex flex-col items-center gap-1.5">
              <div className={cn(
                "w-8 h-8 rounded-full flex items-center justify-center text-xs font-normal transition-all",
                day.active 
              ...
              <span className="text-[10px] font-normal text-muted-foreground">{day.day}</span>
            </div>
          ))}
        </div>
      </CardContent>
