    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/20 flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className="hidden lg:flex flex-col w-[280px] border-l bg-card/50 p-4 gap-4 overflow-y-auto">
          ...
          <div className="bg-gradient-to-r from-purple-900 to-pink-900 rounded-xs border border-purple-500/40 p-4 overflow-hidden relative group cursor-pointer hover:border-purple-500/60 transition-all shadow-md" data-testid="widget-mentor">
