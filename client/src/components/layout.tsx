          ...
          <aside className="hidden lg:flex flex-col w-[320px] border-l bg-card/50 p-4 gap-4 overflow-y-auto">
            ...
            <div className="relative z-10 flex flex-col">
              ...
              <Button 
                ...
                className="w-full rounded-lg h-10 font-bold text-sm bg-love-body text-white border border-transparent hover:bg-[#F5F3FF] hover:text-[#6600ff] hover:border-[#6600ff]/50 hover:shadow-md hover:-translate-y-0.5 transition-all"
          ...
          <Card className="overflow-hidden border-none shadow-sm hover:shadow-md transition-shadow bg-card" data-testid="widget-follow">
            <div className="p-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button className="rounded-lg px-6 font-bold h-10 bg-love-body text-white border border-transparent hover:bg-[#F5F3FF] hover:text-[#6600ff] hover:border-[#6600ff]/50 hover:shadow-md hover:-translate-y-0.5 transition-all" data-testid="button-follow">
                  Follow
                </Button>
              </div>
            </div>
