          ...
          <div className="p-6 border-b bg-gradient-to-br from-[#6600ff] to-[#cc00ff] space-y-4 shadow-sm relative overflow-hidden">
            ...
            <div className="flex gap-2 pt-2">
              <input 
                ...
                className="flex-1 px-4 py-3 rounded-xl border border-white bg-[#F4F4F5] text-sm text-foreground/90 placeholder:text-foreground/90 focus:outline-none focus:ring-2 focus:ring-white shadow-[0_0_30px_rgba(255,255,255,0.6),0_4px_12px_rgba(0,0,0,0.1)] transition-all"
