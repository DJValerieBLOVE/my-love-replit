  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetTrigger asChild>
        {trigger || (
          <div className="hidden lg:block p-4 mt-4 mx-3 bg-gradient-to-br from-purple-900/10 to-primary/10 rounded-sm group cursor-pointer hover:bg-primary/20 transition-colors">
